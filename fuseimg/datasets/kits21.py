...
def my_resize(input_tensor: torch.Tensor, resize_to: Tuple[int, int, int]) -> torch.Tensor:
    ...
    if resize_ratio_xy != 1 or inner_image_depth != resize_to[2]:
        input_tensor = skimage.transform.resize(input_tensor,
...
class KITS21:
    ...
    def dynamic_pipeline():
        ...
        dynamic_pipeline = PipelineDefault("dynamic", [
                ...
                (OpRepeat(OpLambda(func=partial(my_resize, resize_to=(110, 256, 256))), kwargs_per_step_to_add=repeat_for), dict()),
