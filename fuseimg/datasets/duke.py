...
class Duke:
    ...
    @staticmethod
    def dataset(label_type: Optional[DukeLabelType] = None, train: Optional[int] = False,
                cache_dir: Optional[str] = None, data_dir: Optional[str] = None,
    ...
    def static_pipeline(select_series_func, data_dir=None, with_rescale: Optional[bool] = True,
                        ...
                        verbose: Optional[bool] = True, duke_patch_annotations_df: Optional[pd.DataFrame] = None, name_suffix='') -> PipelineDefault:
