...
class ManagerTestCase(unittest.TestCase):
    ...
    def test_epoch_summary_one_source(self):
        ...
        self.manager.state.best_epoch_values = [
            {"metric_1": 85, "metric_2": 84, "metric_3": 71}
        ]
        self.manager._write_epoch_summary_table(
            self.train_dict, self.validation_dict, 0
        )

        summary = self.read_file()
        self.assertTrue(
            "| metric_1                 | 85.0000                  | 90.0000                  | 100.0000                 |"
            in summary
        )
        self.assertTrue(
            "| metric_2                 | 84.0000                  | 70.0000                  | 80.0000                  |"
            in summary
        )
        self.assertTrue(
            "| metric_3                 | 71.0000                  | 60.0000                  | 75.0000                  |"
            in summary
        )
        self.assertTrue(
            "Stats for epoch: 7 (Best epoch is 5 for source metric_1)" in summary
        )
    ...
    def test_epoch_summary_two_sources(self):
        ...
        self.assertFalse(
            "| metric_3                 | 65.0000                  | 60.0000                  | 75.0000                  |"
            in summary
        )
        self.assertTrue(
            "Stats for epoch: 7 (Best epoch is 5 for source metric_1)" in summary
        ...
        self.manager._write_epoch_summary_table(
            self.train_dict, self.validation_dict, 1
        )
        summary = self.read_file()
        ...
        self.assertTrue(
            "| metric_1                 | 81.0000                  | 90.0000                  | 100.0000                 |"
            in summary
        )
        self.assertTrue(
            "| metric_2                 | 89.0000                  | 70.0000                  | 80.0000                  |"
            in summary
        )
        self.assertTrue(
            "| metric_3                 | 65.0000                  | 60.0000                  | 75.0000                  |"
        ...
        self.assertTrue(
            "Stats for epoch: 7 (Best epoch is 12 for source metric_2)" in summary
        )
    ...
    def test_epoch_summary_none_values(self):
        ...
        self.manager.state.best_epoch_values = [
            {"metric_1": None, "metric_2": 84, "metric_3": None}
        ]
        self.manager._write_epoch_summary_table(train_dict, validation_dict, 0)

        summary = self.read_file()
        self.assertTrue(
            "| metric_1                 | N/A                      | 90.0000                  | 100.0000                 |"
            in summary
        )
        self.assertTrue(
            "| metric_2                 | 84.0000                  | N/A                      | 80.0000                  |"
            in summary
        )
        self.assertTrue(
            "| metric_3                 | N/A                      | N/A                      | N/A                      |"
            in summary
        )
        self.assertTrue(
            "Stats for epoch: 7 (Best epoch is 5 for source metric_1)" in summary
    ...
    def test_epoch_summary_string_values(self):
        ...
        validation_dict = NDict(
            {"metric_1": 90, "metric_2": "lili", "metric_3": "lolo"}
        )
        self.manager.state.best_epoch_values = [
            {"metric_1": 14, "metric_2": 84, "metric_3": "kiki"}
        ]
        self.manager._write_epoch_summary_table(train_dict, validation_dict, 0)

        summary = self.read_file()
        self.assertTrue(
            "| metric_1                 | 14.0000                  | 90.0000                  | 100.0000                 |"
            in summary
        )
        self.assertTrue(
            "| metric_2                 | 84.0000                  | N/A                      | 80.0000                  |"
    ...
    def test_is_best_epoch_so_far(self):
        ...
        self.assertDictEqual(
            self.manager.state.best_epoch_values[0],
            {"metric_1": 90, "metric_2": None, "metric_3": "lolo"},
        )
        ...
        self.assertFalse(is_better)
        self.assertDictEqual(
            self.manager.state.best_epoch_values[1],
            {"metric_1": 81, "metric_2": 89, "metric_3": 65},
        )
