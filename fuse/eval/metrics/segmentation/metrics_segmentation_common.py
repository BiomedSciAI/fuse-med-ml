...
def average_sample_results(metric_result : List[Dict[int,float]], class_weights: Optional[Dict[int,float]] = None) -> Dict[str,float]: 
    """
...
class MetricDice(MetricPerSampleDefault):
    ...
    """
    def __init__(self, pred: str, target: str, pixel_weight: Optional[str] = None,class_weights: Optional[Dict[int,float]] = None, **kwargs):
        """
        ...
        super().__init__(pred=pred, target=target, pixel_weight=pixel_weight, metric_per_sample_func=MetricsSegmentation.dice, result_aggregate_func=average , **kwargs)
...
class MetricIouJaccard(MetricPerSampleDefault):
    ...
    def __init__(self, pred: str, target: str, pixel_weight: Optional[str]= None,class_weights: Optional[Dict[int,float]] = None, **kwargs):
        ...
        """
        average = partial(average_sample_results, class_weights=class_weights)
        super().__init__(pred, target, pixel_weight=pixel_weight, metric_per_sample_func=MetricsSegmentation.iou_jaccard, result_aggregate_func=average , **kwargs)
...
class MetricOverlap(MetricPerSampleDefault):
    ...
    def __init__(self, pred: str, target: str, pixel_weight: Optional[str]= None,class_weights: Optional[Dict[int,float]] = None, **kwargs):
        ...
        """
        average = partial(average_sample_results, class_weights=class_weights)
        super().__init__(pred, target, pixel_weight=pixel_weight, metric_per_sample_func=MetricsSegmentation.overlap, result_aggregate_func=average , **kwargs)
...
class Metric2DHausdorff(MetricPerSampleDefault):
    ...
    def __init__(self, pred: str, target: str, class_weights: Optional[Dict[int,float]] = None, **kwargs):
        ...
        """
        average = partial(average_sample_results, class_weights=class_weights)
        super().__init__(pred, target, metric_per_sample_func=MetricsSegmentation.hausdorff_2d_distance, result_aggregate_func=average , **kwargs)
...
class MetricPixelAccuracy(MetricPerSampleDefault):
    ...
    def __init__(self, pred: str, target: str, pixel_weight: Optional[str]= None,class_weights: Optional[Dict[int,float]] = None, **kwargs):
        ...
        """
        average = partial(average_sample_results, class_weights=class_weights)
        super().__init__(pred, target, pixel_weight=pixel_weight, metric_per_sample_func=MetricsSegmentation.pixel_accuracy, result_aggregate_func=average , **kwargs)
