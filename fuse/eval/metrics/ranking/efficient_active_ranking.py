...
class EfficientRanking:
    def __init__(self, items: List[Any], compare_fn: Callable[[Any, Any], bool], 
                 confidence: float = 0.95, min_comparisons: int = 32):
        self.items = items
    ...
    def _compare_with_bounds(self, a: Any, b: Any) -> bool:
        ...
        if (stats_a.comparisons < self.min_comparisons or 
        ...
        return (stats_a.wins / stats_a.comparisons > 
...
if __name__ == "__main__":
    ...
    ranker = EfficientRanking(to_be_ranked, partial(compare_fn, noise_rate=0.1), confidence=0.95)
