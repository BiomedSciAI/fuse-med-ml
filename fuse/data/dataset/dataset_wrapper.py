...
# Dataset processor
class DatasetProcessor(ProcessorBase):
    """
...
class DatasetWrapper(DatasetDefault):
    ...
    def __init__(self, name: str, dataset: Dataset, mapping: Union[Sequence, Dict[str, str]], **kwargs):
        ...
        :param kwargs: optinal, additional argumentes to provide to DatasetDefault
        """
        data_source = DataSourceFromList([(name, i) for i in range(len(dataset))])
