...
class OpIncrForTest(OpReverseableBase):
    ...
    def __call__(self, sample_dict: NDict, op_id: Optional[str], incr_value: int, key_in: str, key_out: str) -> Union[None, dict, List[dict]]:
        # save for reverse
...
class TestOpsCommon(unittest.TestCase):
    ...
    def test_op_repeat(self):
        ...
        kwargs_per_step_to_add = [dict(key_in='data.val.a', key_out='data.val.b'), dict(key_in='data.val.b', key_out='data.val.c'), dict(key_in='data.val.b', key_out='data.val.d'), dict(key_in='data.val.d', key_out='data.val.d')]
    ...
    def test_op_apply_patterns(self):
        ...
        patterns_dict = OrderedDict([(r"^data.val.img_for_testing$", (op_add_1, dict())),
        ...
        op_apply_pat.reverse(sample_dict, key_to_follow="data.val.img_for_testing", key_to_reverse="model.seg_for_testing", op_id="_.test_apply_pat")
        self.assertEqual(sample_dict['data.val.img_for_testing'], 4)
    ...
    def test_op_apply_types(self):
        ...
        types_dict = {DataTypeForTesting.IMAGE_FOR_TESTING: (op_add_1, dict()),
        ...
        op_apply_type.reverse(sample_dict, key_to_follow="data.val.img_for_testing", key_to_reverse="model.a_seg_for_testing", op_id="_.test_apply_type")
        self.assertEqual(sample_dict['data.val.img_for_testing'], 4)
