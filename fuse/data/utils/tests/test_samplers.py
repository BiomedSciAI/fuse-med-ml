...
class TestSamplers(unittest.TestCase):
    ...
    def test_balanced_dataset(self):
        ...
        for idx in range(num_classes):
            ...
            self.assertAlmostEqual(sampled, 1 / num_classes, delta=1 / num_classes * 0.5, msg=f'Unbalanced class {idx}, expected 0.1+-0.05 and got {sampled}')
    ...
    def test_sampler_default(self):
        ...
        # create sampler
        batch_sampler = BatchSamplerDefault(dataset, batch_size=3, balanced_class_name="data.class", num_balanced_classes=3, workers=0)
