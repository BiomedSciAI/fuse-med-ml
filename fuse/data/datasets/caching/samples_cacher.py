...
class SamplesCacher:
    def __init__(
        ...
        **audit_kwargs: dict,
        ...
        :param use_pipeline_hash: indicates whether to use a hash of given pipeline for naming its cache dir. Default=True
        ...
        if "ignore_nan_inequality" not in self._audit_kwargs:
            ...
            ] = True  # as DeepDiff(float('nan'), float('nan')) reports difference
...
def _get_available_write_location(cache_dirs: List[str], max_allowed_used_space=0.99):
    """
