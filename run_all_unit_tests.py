...
if __name__ == '__main__':
    ...
    sub_sections_core = [("fuse/tests", search_base), ("fuse/eval", search_base), ("fuse/utils", search_base)]
    sub_sections_examples = [("examples/fuse_examples", os.path.join(search_base, "examples"))] 
    if mode is None:
