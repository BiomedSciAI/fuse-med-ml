...
TRAIN_COMMON_PARAMS[
    "data.samples_ids"
] = FULL_GOLDEN_MEMBERS  # Change to None to use all members
...
def run_train(paths: dict, train_common_params: dict):
    ...
    train_dataset = ISIC.dataset(
        paths["data_dir"], paths["cache_dir"], samples_ids=train_sample_ids, train=True
    )
...
INFER_COMMON_PARAMS["data.validation_num_workers"] = TRAIN_COMMON_PARAMS[
