...
def download_and_extract_isic(root_data: str, year: str = "2016"):
    ...
    if year == "2016":
        ...
        if not os.path.exists(os.path.join(root_data, "data/ISIC2016_Training_Data")):
            ...
            os.rename(
                os.path.join(root_data, "data/ISBI2016_ISIC_Part3_Training_Data"),
        ...
        if not os.path.exists(
            os.path.join(root_data, "data/ISIC2016_Training_GroundTruth.csv")
        ):
            url = "https://isic-challenge-data.s3.amazonaws.com/2016/ISBI2016_ISIC_Part3_Training_GroundTruth.csv"
            wget.download(
                url, os.path.join(root_data, "data/ISIC2016_Training_GroundTruth.csv")
            )
        ...
        if not os.path.exists(os.path.join(root_data, "data/ISIC2016_Test_Data")):
            ...
            z.extractall(os.path.join(root_data, "data"))
            os.rename(
                os.path.join(root_data, "data/ISBI2016_ISIC_Part3_Test_Data"),
        ...
        if not os.path.exists(
            os.path.join(root_data, "data/ISIC2016_Test_GroundTruth.csv")
        ):
            url = "https://isic-challenge-data.s3.amazonaws.com/2016/ISBI2016_ISIC_Part3_Test_GroundTruth.csv"
            wget.download(
                url, os.path.join(root_data, "data/ISIC2016_Test_GroundTruth.csv")
            )
    ...
    if year == "2017":
        ...
        if not os.path.exists(os.path.join(root_data, "data/ISIC2017_Training_Data")):
            ...
            z.extractall(os.path.join(root_data, "data"))
            os.rename(
                os.path.join(root_data, "data/ISIC-2017_Training_Data"),
        ...
        if not os.path.exists(
            os.path.join(root_data, "data/ISIC2017_Training_GroundTruth.csv")
        ):
            url = "https://isic-challenge-data.s3.amazonaws.com/2017/ISIC-2017_Training_Part3_GroundTruth.csv"
            wget.download(
                url, os.path.join(root_data, "data/ISIC2017_Training_GroundTruth.csv")
            )
        ...
        if not os.path.exists(os.path.join(root_data, "data/ISIC2017_Validation_Data")):
            ...
            z.extractall(os.path.join(root_data, "data"))
            os.rename(
                os.path.join(root_data, "data/ISIC-2017_Validation_Data"),
        ...
        if not os.path.exists(
            os.path.join(root_data, "data/ISIC2017_Validation_GroundTruth.csv")
        ):
            url = "https://isic-challenge-data.s3.amazonaws.com/2017/ISIC-2017_Validation_Part3_GroundTruth.csv"
            wget.download(
                url, os.path.join(root_data, "data/ISIC2017_Validation_GroundTruth.csv")
            )
        ...
        if not os.path.exists(os.path.join(root_data, "data/ISIC2017_Test_Data")):
            ...
            z.extractall(os.path.join(root_data, "data"))
            os.rename(
                os.path.join(root_data, "data/ISIC-2017_Test_v2_Data"),
        ...
        if not os.path.exists(
            os.path.join(root_data, "data/ISIC2017_Test_GroundTruth.csv")
        ):
            url = "https://isic-challenge-data.s3.amazonaws.com/2017/ISIC-2017_Test_v2_Part3_GroundTruth.csv"
            wget.download(
                url, os.path.join(root_data, "data/ISIC2017_Test_GroundTruth.csv")
            )
