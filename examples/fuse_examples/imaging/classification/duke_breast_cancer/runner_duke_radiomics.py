...
def run_train(paths: dict, train_params: dict, reset_cache=False):
    ...
    params = dict(label_type=train_params['classification_task'], data_dir=paths["data_dir"],
                  cache_dir=paths["cache_dir"],
                  reset_cache=False,
                  sample_ids=train_params['data.selected_sample_ids'], num_workers=train_params['data.train_num_workers'],
