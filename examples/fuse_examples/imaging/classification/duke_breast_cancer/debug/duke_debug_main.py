...
def main():
    ...
    if False:
        ...
        static_pipeline = duke.Duke.static_pipeline(
            data_dir=os.environ["DUKE_DATA_PATH"], select_series_func=duke.get_selected_series_index
        )
        # k = 5  #ok
        # k = 8
...
def derive_fuse2_folds_files():
    input_filename_pattern = os.path.join(DUKE_PROCESSED_FILE_DIR, "dataset_DUKE_folds_ver{name}_seed1.pickle")
