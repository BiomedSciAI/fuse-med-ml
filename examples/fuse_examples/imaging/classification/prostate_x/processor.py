...
if __name__ == "__main__":
    ...
    if dataset == "prostate_x":
        ...
        a = ProstateXPatchProcessor(
            ...
            data_path=prostate_data_path,
            ktrans_data_path=Ktrain_data_path,
            db_name=dataset,
            fold_no=1,
            lsn_shape=(13, 74, 74),
        )
        ...
        l_seq = pd.read_csv(
            "/gpfs/haifa/projects/m/msieve_dev3/usr/Tal/my_research/virtual_biopsy/prostate/prostate_x/metadata.csv"
        )
