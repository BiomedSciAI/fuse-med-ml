...
from fuse_examples.imaging.classification.prostate_x.dataset import prostate_x_dataset
...
def train_template(paths: dict, train_common_params: dict):
    ...
    # Data
    # ==============================================================================
    train_dataset, validation_dataset = prostate_x_dataset(
