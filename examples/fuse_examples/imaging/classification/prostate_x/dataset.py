...
from fuse_examples.imaging.classification.prostate_x.processor import (
    ProstateXPatchProcessor,
)
from fuse_examples.imaging.classification.prostate_x.post_processor import (
    post_processing,
)
...
def prostate_x_dataset(paths, train_common_params, lgr):
    ...
    generate_processor = ProstateXPatchProcessor(
        vol_processor=DicomMRIProcessor(
            reference_inx=0,
    ...
    aug_pipeline = [
        ...
        [
            ...
            {
                "apply": RandBool(0.5)
                if train_common_params["data.aug.phase_misalignment"]
                else 0
            },
        ],
        [
