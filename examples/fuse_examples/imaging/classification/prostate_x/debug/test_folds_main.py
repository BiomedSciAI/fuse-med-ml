...
def main():
    ...
    dataset = prostate_x.ProstateX.dataset(label_type=label_type, train=False, cache_dir=cache_dir, data_dir=data_dir)

    df_folds1 = df_read_and_test_folds(
        "/projects/msieve_dev3/usr/ozery/fuse_examples/prostate_x/prostatex_8folds_v2.pkl"
    )
...
def read_and_test_tal_folds():
    filename = (
        "/projects/msieve_dev3/usr/common/prostatex_processed_files/dataset_prostate_x_folds_ver29062021_seed1.pickle"
    )
    with open(filename, "rb") as infile:
