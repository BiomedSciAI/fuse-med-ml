...
class ClassificationMGCmmdTestCase(unittest.TestCase):
        ...
        self.cfg = NDict(
            {
                "paths": {
                    ...
                    "model_dir": os.path.join(
                        self.root, "model_new/InceptionResnetV2_2017_test"
                    ),
                ...
                "train": {
                    ...
                    "manager_train_params": {
                        "num_gpus": 1,
                        "device": "cuda",
                        "num_epochs": 3,
                        "virtual_batch_size": 1,
                        "start_saving_epochs": 10,
                        "gap_between_saving_epochs": 100,
                    },
                    "manager_best_epoch_source": {
    ...
    def test_runner(self):
        ...
        choose_and_enable_multiple_gpus(
            self.cfg["train.manager_train_params.num_gpus"], force_gpus=force_gpus
        )
