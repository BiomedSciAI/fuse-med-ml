...
from data.data_ops import OpNormalizeMRI, OpResize3D, OpRandomFlip, OpSegToOneHot, OpRandomCrop
...
class SegOAI:
    ...
    @staticmethod
    def dynamic_pipeline(validation: bool = False, resize_to: Sequence = [40,224,224]):
        """
    ...
    def dataset(
        ...
        dynamic_pipeline = SegOAI.dynamic_pipeline(validation=validation, resize_to=resize_to)
