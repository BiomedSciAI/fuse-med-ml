...
##############################################################################
losses = {
    'cls_loss': FuseLossDefault(pred_name='model.logits.head_0', target_name='data.gt.gt_global.task_1_label',
...
##############################################################################
metrics = {
    'auc': FuseMetricAUC(pred_name='model.output.head_0', target_name='data.gt.gt_global.task_1_label'),
    'accuracy': FuseMetricAccuracy(pred_name='model.output.head_0', target_name='data.gt.gt_global.task_1_label'),
    'sensitivity': FuseMetricConfusion(pred_name='model.output.head_0', target_name='data.gt.gt_global.task_1_label', metrics=('sensitivity',))
