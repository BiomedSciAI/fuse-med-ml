...
# Train Template
#################################
def train_template(paths: dict, train_params: dict):
    # ==============================================================================
    # Logger
    # ==============================================================================
...
def analyze_template(paths: dict, analyze_common_params: dict):
    ...
    metrics = {
        'accuracy': FuseMetricAccuracy(pred_name='model.output.classification', target_name='data.label'),
        'roc': FuseMetricROCCurve(pred_name='model.output.classification', target_name='data.label', output_filename='roc_curve.png'),
    ...
    analyzer.analyze(gt_processors={},
...
if __name__ == "__main__":
    ...
    if 'train' in RUNNING_MODES:
        train_template(paths=PATHS, train_params=TRAIN_COMMON_PARAMS)
