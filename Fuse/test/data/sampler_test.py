...
class FuseSamplerBalancedTestCase(unittest.TestCase):
    ...
    def test_balanced_dataset(self):
        ...
        dataset = FuseDatasetWrapper(dataset=self.torch_dataset, mapping=('image', 'label'))
        dataset.create()
    ...
    def test_unbalanced_dataset(self):
        ...
        # wrapping torch dataset
        unbalanced_dataset = FuseDatasetWrapper(dataset=self.torch_dataset, mapping=('image', 'label'))
