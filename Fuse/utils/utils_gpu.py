...
class FuseUtilsGPU():
    ...
    @classmethod
    def choose_and_enable_multiple_gpus(cls, num_gpus_needed: int, force_gpus: Optional[List[int]] = None) -> None:
        """
        ...
        if available_gpu_ids is None:
            ...
            print('FuseUtilsGPU: selecting GPUs %s' % str(selected_gpu_ids))
